...
public class TagManagerDataLayerPushTransformation extends ReplaceMethodTransformation {

    public TagManagerDataLayerPushTransformation(String owner, String name, String desc) {
    ...
    public static class Factory implements MethodVisitorTransformationFactory {
        public MethodVisitorTransformation newTransformation(String className, String methodName, String methodDesc) {
            return new TagManagerDataLayerPushTransformation("com/trackingplan/client/sdk/interception/tagmanager/DataLayer", "push", "(Lcom/google/android/gms/tagmanager/DataLayer;Ljava/util/Map;)V");
        }
    }
}
