...
Select the `project-level build.gradle` file and add `com.trackingplan.client:adapter:1.5.3` as a classpath dependency to the dependencies section:

```gradle
dependencies {   
    // ...
    classpath "com.trackingplan.client:adapter:1.5.3"
    // ...
}
```
...
- Add `implementation 'com.trackingplan.client:sdk:1.5.3'` to the dependencies section.
```gradle
dependencies {
    // ...
    implementation 'com.trackingplan.client:sdk:1.5.3'
    // ...
}
```
...
1. Add `com.trackingplan.client:junit-tools:1.5.3` as a `androidTestImplementation` dependency to the dependencies section of your module-level `build.gradle` file:

```gradle
dependencies {
    // ...
    androidTestImplementation "com.trackingplan.client:junit-tools:1.5.3"
    // ...
}
```
